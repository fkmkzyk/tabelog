...
4. 禁止事項:
   ...
   - 具体的な日付（「2026年7月15日」「7月15日」のような年月日・月日の表記）を、タイトルやコメントに絶対に含めないでください。時期に触れる場合は「7月中旬」「夏」「夜」「ランチ」程度の粒度に留めます。
...
2. 禁止事項の徹底排除:
   ...
   - 「◯年◯月◯日」「◯月◯日」のような具体的な日付表記がタイトルやコメントに含まれている場合は、削除するか「◯月中旬」「夜」など季節・時間帯レベルの表現に必ず言い換えてください（季節・時間帯への自然な言及自体は残して構いません）。
3. トーンの調整:
